...
class ALUControlUnitRTypeTester(c: ALUControl) extends PeekPokeTester(c) {
  ...
  val tests = List(
    ...
    (       1.U, "b0000000".U, "b000".U, "b00001".U, "add"),
    (       1.U, "b0100000".U, "b000".U, "b00100".U, "sub"),
